...
- Also assess: does the new deck have ANY Strength source? Pandora's Box removes Strikes (base damage), so without [[cards/Inflame]], [[cards/Spot Weakness]], or similar, the deck has no scaling. A skill-heavy Pandora's Box deck cannot kill bosses fast enough — Guardian at 240 HP requires Strength to outpace its damage cycles.
