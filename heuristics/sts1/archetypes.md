...
## [[characters/Silent]] (2 wins / 19 runs)
...
## [[characters/Defect]] (1 win / 4 runs)
...
**No proven archetype yet.** Stance dance (Wrath/Calm cycling) is the primary engine under development. The engine assembles reliably. Execution is now clean. Deaths are now strategic/knowledge gaps and HP management: Hex vulnerability (191), HP management under bad relics (192), Wrath damage miscalculation (193), and HP attrition through Act 3 without healing (196). Best floor: 39 (Run 196). Run 196 had the full engine assembled (Rushdown 4, Deva Form, Devotion+, Battle Hymn, Wave of Hand, 2x Flurry of Blows) and was performing cleanly through Act 3 but died to Spire Growth's Constricted at 9 HP — the Watcher has no built-in healing and HP attrition was fatal.
...
(1) Zero UI misplays, (2) zero arithmetic errors, (3) strong [[acts/Act 1]] performance, (4) proper map pathing, (5) a complete scaling engine -- not individual strong cards. Strength scaling is the most proven path (3 wins). The Corruption+FNP block engine has won twice but always alongside Str sources — its independence is under investigation. The Watcher's 0-win record across 14 runs initially correlated with execution errors (runs 188-190), but after execution was cleaned up (runs 191-193), deaths shifted to knowledge gaps and HP management. Run 196 reached Floor 39 with a fully assembled engine but died to HP attrition (no healing sources). The key is having SOME scaling path AND clean execution AND correct fight-specific knowledge AND (for Watcher) sufficient HP management to survive Act 3 without built-in healing.
