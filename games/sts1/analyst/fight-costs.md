...
- The Champ | death from 48/85 (entered 56%; Face Slap stacked 2 Frail x2 + 2 Vuln, P1 debuff loop outscaled thin block: T6 9 HP, T7 19 vs 6-Frail'd block = lethal, Champ still at ~302/440 = P1) | A9 | Ironclad | Snecko/Reaper burst deck, ~40-50/turn raw but block-light (Flame Barrier + Shrug + Bronze Scales only); the killer is the Champ's block-erasing Frail+Vuln loop against a deck with no passive/repeatable block, NOT damage — a debuff-stacking boss prices much higher than its attack table for a thin-block deck | run 248
- Shelled Parasite + Fungi Beast | 39 (55 -> 16, won at full block on the kill turn) | A9 | Ironclad | Chemical-X Whirlwind multi-hit as the Plated-Armor stripper (X=3 -> 5 hits), Immolate AOE clearing Fungi + stripping Parasite block; correct line, but the armor-regen wall is a structurally expensive Act-2 hallway fight (~33 HP) for a burst deck with no Weak source | run 248
