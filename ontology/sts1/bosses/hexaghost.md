...
**Strength scaling:** Inflame gives Hexaghost +2 [[buffs/Strength]] each 7-move cycle, raising the damage of ALL its attacks (Sear, Tackle, Inferno) by 2 per hit per stack. Because Inflame fires *before* Inferno within the same cycle, the base 2x6 = 12 Inferno never actually occurs: the **first Inferno hits at 24** (4x6, after one Inflame), the **second at 36** (6x6, after two).
