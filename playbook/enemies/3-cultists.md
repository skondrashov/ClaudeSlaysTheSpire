...
BENCHMARKS: **Enter with 50%+ HP MINIMUM -- this is a hard threshold, not a guideline.** Four encounters confirm this: three deaths at 30%, 37%, and 39% HP entry, and a fourth at 53% HP where Ritual scaling outpaced blocking despite Immolate (AOE), Impervious+ (40 block), and Calipers (block retention). Even strong defensive tools cannot compensate for low HP entry because the fight demands both burst kill speed AND sustained block for 4-6 turns simultaneously. The math is simple: if you cannot survive 4 turns of 18-27 combined damage per turn (after Weak), you die.
