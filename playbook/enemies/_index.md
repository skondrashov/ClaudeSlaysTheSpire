...
- [Jaw Worm](jaw-worm.md)
- [Cultist](cultist.md)
- [Louse](louse.md)
- [Red Slaver](red-slaver.md)
- [Looter](looter.md)
- [Fungi Beast](fungi-beast.md)
...
- [Lagavulin](lagavulin.md)
- [Gremlin Nob](gremlin-nob.md)
- [Sentry](sentry.md)
...
- [Snecko](snecko.md)
- [Shelled Parasite](shelled-parasite.md)
...
NOTE: Spikers and Exploders are documented in strategy.md (Act 3 Key Enemies) but do not yet have individual playbook entries. Create entries when first encountered in more detail.
