...
APPEARS WITH: Cultist (in multi-enemy fights). When paired, Cultist buffs turn 1 while Chosen applies Hex -- the combined threat is extreme. Kill Cultist first (lower HP, less block needed) then focus Chosen.
